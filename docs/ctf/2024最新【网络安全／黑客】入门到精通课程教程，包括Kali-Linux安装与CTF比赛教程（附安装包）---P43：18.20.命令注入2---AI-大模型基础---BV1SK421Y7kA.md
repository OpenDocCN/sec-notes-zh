# 2024最新【网络安全／黑客】入门到精通课程教程，包括Kali Linux安装与CTF比赛教程（附安装包） - P43：18.20.命令注入2 - AI-大模型基础 - BV1SK421Y7kA
...
打开一个终端。MSF然后tab，然后vieno杠P。接下来是linux。S86。没车。P pretty。呃，接下来是。咱们reverse。杠TCP。🤧嗯。接下来哎是low host。等于192。168。
