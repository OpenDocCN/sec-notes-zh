# CTF教程：CTF初学者必备的1000个练习题，每日一练，百日成神！（ctf-wbe／ctf-pwn／ctf-misn／ctf-逆向） - P34：ret2text - 白帽子讲安全 - BV1dp4y1j7aN
...
程序员自己写上去了。所以呢有就是这个功能很有用，你可以按ship加F12。嗯，有时候你的电脑就像我此是这样，它的F12和就是它的功能键是重的那需要MN加加102，然后打开一个字符串的界面。
