# B站最好的清华蓝莲花战队CTF夺旗赛教程 从小白入门到比赛实战 - P13：13.CTF赛前指导杂项：压缩+流量（最后命令手敲才可以） - 黑客入门101 - BV1ReW5eJEAX
...
要改改回来嘛。OK那我们继续。啊，有些时候呢你遇到这种情况，你就必须用暴力破解的方式。啊，暴力破解方式，而且呢暴力破解的话，它或多或少都会绝对会给你提示的。比如说这是一个什么几位的一个密码。😡。

如果是10位的数字的话，非常好算。打比方，如果你密码是10位数的，而且是10个什么都是数字组成的，破解的时候还是蛮快的那如果说是数字加大小写字母，再加上一些常见的特殊字符，那你可能算一天都算不出来啊。

一般情况下它会干嘛呢，比如说啊他会给你提示说前面的部分，前面5个5个5个密码已经告诉你了，他要求你算后面的5个密码，那这个也是OK的，这也是OK的。我们来看一下这个暴力破解啊。😡，来。

这里有个暴力破解啊。那那我们现在把这个工具给它打开啊，稍等一下工具。在我们的CTF工具包里面，杂项啊压缩包破解工具。这里有一个什么第1个AACR的这个啊，这个安装完安装完安装完之后呢，给它打开就可以了。

ARCARCHHRHPR的这个软件。啊，首先呢打开。打开我想要去破解的暴力破解这个。😊，压缩包，比如GIP。啊，比如说GIPOK那我去跑，有时候呢它自动就开始帮我进行进行运行了，就自动已经帮我运行了啊。

那OK那没关系，我们等它就可以了啊。那如果当它怎么样呢？当它把这个密码给它破出来之后呢，它就会弹窗啊，它会是弹弹出来，弹到我们这个页面上就可以了啊那这样子我们就算完成它的一个破解。😊，啊。

有时候呢它比较比较比较快啊，像这种这种密码的话是非常简单的非常简单的那我们直接把它复制啊。😊，粘贴到他该去的一个地方来解压是吧？要是输入密码啊啊，回车。啊，就可以。解压出来了。

解压出我们的一个T一样的是这个啊，记住了，像这种flag中间是没有空格的。😡，这里呀这里是没有了啊。😡，啊，这是规定啊。啊，这里这种这种是不能有空格的，你提交的时候就没有空格了。

我就里面了啊里面是没有空格的啊，要注意啊。OK这个比较简单。来我我们来简单看一下这个程序有哪一些东西啊。😊，程序来简单看一下，它有针对这种这种攻击攻击类型啊。你比如说暴力破解，暴力破解。

其实说白了它是有字点的。什么叫字典的？就是我事先把一堆的密码，我比如说我知道你是数字的嘛，我知道你是数字排列组合的那我就是用写出一个什么呢？啊。

用密码机器或者其他的工具写出一个数字数字组成的一个排列组合，然后反正弄在一个TIT文本里不断不断的去破解嘛，O这个是叫暴力破解。那一般情况下呢，这个软件它是有自带的一个字典的。
...
那你要选这里要选一个什么，你把这个压缩包选中嘛，然后呢这个地方选铭文。😡，灵魂的攻击方式，并且呢把要把那个TSTTST文本给它放到这边来。TST文本也是作为密钥的一部分，你放到这边来，然后进行破解。😡。

进行破解就可以了啊。ok但是呢它没有那么没有那么那么简单哈，他需要这么做哈。😊，系。铭文攻击只知道加密的GIP中部分文件的铭文内容。啊，铭文内容应该叫是明文内容哈啊利用这些内容推测出密钥，并且解密。😊。
...
稍等一下。一般情况下，我们要怎么找呢？我们要去找这个。😡，这是这里有一个值哈，这里有个值啊。😊，哎，我找一下。there is no呃什么鬼了？哎呀。看一下ask克码子啊，稍等一下啊。我搜一下吧搜一下。
...
那如果说是什么相对流量的话呢，是相对来说比较简单一点。那上次课呢我们简单的对流量啊，之前那个课简单对流量做了一个简单的一个讲解。那我这时候再强调一遍啊，我们来看一下啊。😊，这个工具叫什么？快呀。啊。
...
有时候都是比较大了。所以说我要你么限定一下它的长度啊。你比如说我发我发现它是1个TCP的包，发现它是1个UDP的包，打个比方，比如说这是TCP的包，那我就要限定它大于某个值。😡，大于某个值。
...
打开啊。他已经给你提示了是吧？什么叫衰啊？😡，什么叫谁啊？什么叫谁啊？实上简单来说的话，就这个。这种就是一个。但是呢他不确定是linux的s。😡，还是windows的Cll。

还是HTTP网页的一个sll网站的一个木马嘛。网站如果说被re要被人获取了，基本上都能干干任何事情了啊，那我现在不懂是不是不懂，我就要去研究。这里有一个哈。😊，统计。选择协议分级。

如果是英文是什么st啊tical啊，还有什么prob呃，好吧。😊，我承认我英语不是很好啊。啊。这里有哈。statictics啊，proical啊，那啥来着？啊，嗯嗯没错，对，就是那。统计协议分级。

那我们先把它收起来哈。😊，所有的数据基本上都是什么？因为我们数据是有封装的嘛，数据你说我们在我们在往。😡，数据在传的时候肯定是0101的数据，对吧？就是这种数据流嘛。

它是怎么表示成图片文字声音肯定是有需要经过一层层的一个封装解封装和解封装的过程啊。😡，OK首先是一个真嘛，基本上我们能抓的抓的数据，基本上是以太网。什么叫以太网啊？😡，这种网线这种正常的网线啊。来往。

然后的话呢你看着。😡，我们用的比较多的是。😡，IPP6还是IIP4啊？😡，V4是吧？对，所以说我们要打开。再来看一下。用的比较多的是UDB还是TCP。😡，TCP啊，所以说数据包是你想啊，它传那么少。

它传这个数据本来就传的这么少。你觉得fllaag有可能它仓在放在这吗？不可能吧，来。😡，哎，看到。😊，这里有1个TC密码，更多的一个包。😡，啊，他有时候呢放在哪里啊啊。

你比如说什么放在我们的一个data里面啊，data里面。但是呢这题的话呢啊有可能就是不是这样做了啊，这题就不是这样做了啊，那反正你要去用用东西去套它，用这东西去套它啊，套出它一个东西来啊。

这个其实呢课件上的这一题呢，它是在哪呢？就是那一张我给你们看了一张会。😊，会飞的苍蝇啊会飞的一个苍蝇啊会飞的一个苍蝇。啊，你比如说什么我们这个数据嘛，你看下我给大家干嘛了啊，作为过滤器应用啊。

给大家干嘛了选中一下。啊，这个也不是不可以啊，但是呢这个这个地方呢这个数据呢太难找了太难找了啊，不是这样，这题不是这么做了啊，这题是这个我们的个会飞的苍蝇那题啊。😊，就他这个人啊可以找到一个呃呃包啊。

找到一个包来，稍等一下，我再给他打开给你们看一下啊。你看呢统计呀。简疑分级啊。这里的话呢我们可以快速定位到哈。😊，肯定是IP4啊，不用讲。啊，也是TCP了。啊，TCB这边有一个啊，你看到啊。😊。

是一个好像是一个什么。😡，啊，一个文件包啊，你看传的这个数据啊，我们可以干嘛啊，给它试一下啊。😊，给它作为一个过滤器，给它啊选中一下啊，给它选中一下啊，给它选中一下啊，就是把它选中，然后我们再进行分析。

进行接下来一个分析就可以了。😊，那如果说你选非选中，就是说除了这个地方。就是说刚才这个选就是说只要包含的这个什么媒体的一个type的一个文件，流量包啊，全部给它选中，给它过滤，给它过滤筛选出来。

那非常非常中就是说只要包含这个东西的，全部给我剔除掉。为什么我要选中它，你想啊，我如果说是一个。😡，大的一个数据包好，看到，如果我们是一个大的数据包，那我是不是要分好几个啊？😡，对吧好几个嘛。

然后等一下呢要把这个什么每相关的部分，每一个包的相关的部分给它组合成一个包嘛，那我肯定要把这个东西给他选中嘛。😡，啊，你看没有？每一个都有每个包都有这个每个包有都有这个每个包都有。啊。

每个每个包都有随便点一个，每个包都有啊，那再把这些东西组合起来啊就可以了。稍等一下。你看呢。这里也也可以用什么了，作为过滤器来应用啊，也可以啊，都可以啊，选中都可以了啊。OK。讲了多久啊？

那我们休息一下吧啊休息一下吧。部分同学已经懵了啊。嗯。针对刚才这个那那只苍蝇的那一题啊，或者说针对这种蹄的话呢，它有几个小技巧啊，你比如说。点那个统计，然后协议分级可以看得到呢。

它每一个每个数据更多的时候它是更多的数据是占用在哪一块的那我可以把它筛选出来啊，再把它这些数据进行分离就可以了。至于怎么分离的话呢，我这就不多讲了哈，我不多讲了，时间有限啊。

我们接着把往下面的一个东西抢一下哈啊，还可以针对80端口进行筛选了，进行筛选，这个我也不多说了。😊，啊，来这里有一道题啊，这个题还是挺有意思的。😡，就我们可以进行一个收流的一个什么啊留的一个呃追踪啊。

留的一个追踪。因为有时候它的一个数据数据是连续的嘛，有时候是数据是连连续的，我可以怎么针对某一个数据流进行一个分连系的一个分析分析啊啊，为什么我我讲的口音都有点怪怪的。😊，啊，来我们来看这题啊。😊。
...
一般情况下，你们用CL就是制符界面。一般情况下你们会敲什么，你们会做什么？😡，首先要敲命令嘛，你比如说我要加1个LS嘛，敲一个什么L是什么，还记得吗？😡，linux里面查看这文件底下有哪一些数据嘛？

还有一个什么？如果是放在windows里面，用什么命令啊？😡，DIRdirectyory directory啊，在哪啊？在我们的CMD下面。😊，D二啊，我就看到底下有哪些，那我就可以根据这些内容啊。
...
😊，啊，这个命令的意思。啊，很慢。啊，然后一条链是分析一条就分析，你看着啊这每每点一条，它底下都有信息，是不是？这是它的一个什么真的那一个数据的一个封装格式啊，就每一层啊，你看啊从底层到它什么数据层啊。

不是其实不叫数据层，叫什么应用层啊，来它底下呢是对应的什么十六进制数，十六进制数啊，这些全部都是数据啊。😊，啊，除了这个针头啊除了这个针头啊，其他都是数据啊，看到，我们往下翻一下啊。

我们看一下这个data啊，data这个地方啊，这里有一个数据啊，我们看一下往下拉一下啊，看这个16进制数啊。😊，好，这个地方好像看不出什么东西来啊，那我们往下。😊，其实呢我可以直接给大家说了。

就是最后这一行最后这一行，最后这行他看什么了？看这个地方。😡，这是什么？😡，这是什么啊？😡，来看着啊。对吧。是不是也可以认为它有可能是windows的一个sll，windows的c被它获取了嘛。啊。

其实这边有没有LS呢？有就刚包含在刚才那个地方。因为刚才那个我搜索出来的时候太多了嘛，我懒得一个个去搜，所以说我要一个个分析，一个个去分析OK找到了之后我干嘛啊？😡，针对流进行一个什么追踪。
...
然后把它打开type的意思就是查看里面的内容，查看里面的内容，发现这一串，知道是什么吗？😡，知道了吧？然后他直接了一个关机。啊，并且留下一个信息，这信息是什么？我们就不多说了啊。😊，stup啊。

s stupiduppy是什么意思啊？😡，啊。OK那我们只要把这段干嘛拿下来嘛，使用我们的火狐，这地方火狐啊是可以进行解密的。😊，我之前不知让你们下安装这个哈克霸了啊，这个可以扩展了一下。

这里面有一个解密码。😊，这个什么？加加解密这个64的一个解码嘛。所以这个flag就帮我体现在这儿了。啊。是因为什么呢？

我刚好在这个地方这个留这个地方这个这里看到这个呢我就是猜测性的一个去给它啊弄一下试试哈。其实呢。😊，他这个地方有没有啊？😡，他地方有没有了？t有没有？😡，但是我不怎么看得懂嘛，我想要让它显示出什么。

它该显示的样子嘛，就这样子嘛啊就这个样子嘛，它是它该显示的位置啊。😡，OK这是我们这一题啊。相对来说啊有点题目做多了还是ok的。奶。你比如说你要看到它的原理质量在关注的哎。我用这个用笔呀。

在关注的HTTB数据包中或者TCP数据包中，选择留汇聚，可以将HTP流或者TCP留汇聚或者还原成。啊，数据就是让他还还原这个数据啊，在弹出的框中可以看到信息。我告诉你为什么会这样子啊。😡。

在我们流网络中啊。😡，数据是有去有回的，什么叫有去有回啊？我发发的一个请求嘛，他要给我显示一个东西，这个叫伙数据有过去有回来，明白我的意思吧？不然的话，我只过去没回来，那肯定是不行的。
...
就是我只只说他收音机在播放那个电台的时候，那个那个过程是什么是一个单向的一个过程嘛，对吧？😊，就没有一个回显嘛。那你比如说我的屏幕或者我我们的一个电脑是吧，我输入什么信息，它电脑上面会显示什么信息嘛。

对吧？😡，是。还有一些信息啊，还有信息比较比较比较有意思的哈。😊，一句话木马，所谓的一句话木马。😡，啊，一句话木马呢是一个就是我们利用它有一些有时候我们正常情况下，我们不是很多情况下可以上传上传文件吗？

你比如说什么。😡，随便一个网页能不能上传头像呃，啊，反正你们也看不清啊。😡，随便一个地方上传一个头像嘛啊，对吧？啊，那我可以怎么样给他上上传一个恶意脚本，可不可以呢？可以，如果说他没有做校验的话。

上传一个恶意恶意的木马文件上去之后，我就可以对他进行控制。这种呢叫做一句话木马可以实现啊。😊，啊，不用看了。嗯。来。啊，比如说我们这边有一个。嗯，看一下看下哎。我们看一下这个东西啊。你比如说他这边啊。

比如我们可从这边可以看得到，看到。😊，我们从从这边是可以看得到他是在做一个什么。😡，我们认为他有可能在做一个什么上传的东西嘛，那我来给他看一下嘛。😡，啊，追踪一下。就重加他的一个什么HTTP流嘛。

这时是HTTP嘛，对吧？😡，看到没有？有一个evo的一个关键字关键字啊关键字。我们可以把这个东西呢干嘛了？😊，唉，这个这个这我看一下。c是吧，那好吧，保存一下吧。看到啊。我这边啊就保存在这儿。

还没办法全部保存是吧？看一下稍等一下，我看一下啊。但是这个就是另重围了呃，不不算是保存的，看一眼啊。稍等一下。哎，我想想啊。遇到这种的话呢，一般情况下我们可以把它全部保存了啊。

我想一想是是我这个东西错了吗？没错吧。还是说我要把它。等一下啊。但也不对呀，如果说我把这个保存下来也不对呀。我想拿它导出来都不行，是吧嗯？没错啊。看一下我们看一下PPT上有没有提示啊。诶。

这边也没有是吧？这是导出对象吗？看一下，是我就没这个选项还是怎样的。导出对象有哈。把这个HTTB给它导出来啊，这里的话包含好几个好几个文件啊，什么意思啊？来等一下，我要重新讲一下啊，可能一直一直混了啊。
...
比如说我导出成为一个什么把这个HTTP导出来啊，看着。会有这么几个啊。看一下是不是哈，我们试一下啊。safe2啊，我们保存所有啊，把它保存在我们这个一句一一句话这边了。这样保存就可以了。来这什么啊？

这什么？PHP脚本文件脚本文件可不可以用我们的note pad夹家打开？😊，可以吧，显然是可以的嘛，对吧？ok。😊，但是因为这些东西呢，一般情况下这么多文件你怎么去看啊？😡，等一下，我先更改一下。

打开方式为默认为那个notepa加加吧。还没有是吧。没有，下次再弄吧来。一般情况下你有这么多文件，你怎么看啊？😡，一般情况下你有这么多文件，你怎么看啊？是不是首先要看一下。😡，一般情况我是这么看的来。

😡，4K1K1KK哎。有一个什么。1238K的是吧？那我先看一下它是不是有问题啊，这个啊。编辑一下。这里啊。看花眼了是吧？哎，什么。什么。这地方有没有可能是一个。被思。对吧。来这个地方。

89504E47好熟悉呀。好熟啊，谁帮我看一下。😡，来这个是不是一个b呢？这是不是一个b呢？这下面是不是又是一个base呢？啊，并且我把这个东西导出来，是不是这样子给它手动导出来。

是不是又可以保存成一个文件呢？是不是flag就在这里面了？😡，对吧这种都是有可能的都是有可能的啊。哦。为什么会还是题目已经给你提示的很清楚了啊。😡，首先是一句话，菜刀，一句话木马啊，用菜刀啊。

这个涉及到一个新的东西，是一句话木马的东西啊。那我们等到。😊，外b的时候再稍微提一下，这是一个利用上传漏洞。通过工具把东西给它上传下去，然后去原我把我把木马连上传上去，是不是要连接它啊。
...
你敲的你键盘敲的所有东西都会都会被它记录下来。😡，都会被他记录下来。一样的，如果你接的这一个鼠标，你的移动轨迹也会被记录下来。😡，鼠标会用到什么左键吧。😡，右键吧啊还有什么。

还有还有你这个这个这个滑动的一个尾迹啊，都可以被它弄出来啊，弄出来再用这个。😊，在用这个看这个流量包的时候啊，USB有流量包的时候，我们首先要选中这个。😡，选中这个。我们看一下在哪。USB啊。啊。

不11号。我简单简单稍微讲一下啊。比如说我打开第二个包啊。😡，这里有一个。USB的一个流量。你看比如我点这个包，它这这底下是不是有一个capual data。😡，对啊，我看一下是不是是不是PPT这个。

开不出 datata，对吧？😊，这里呢你必须给它选。😡，应用为列。因为为列的话，它这边这个数据这个是真实的数据，有效的数据。说白了就是我USB的一个有效的数据形式就是藏在这儿。😡，躺到这儿。
...
主要是集中在第三个字节，就这个地方。😡，那我们看一下它有8个字节啊。😊，有没有八个字节呢？😡，1234对吧？啊，那剩下我就不多说了哈，也就意味着它的一个数据主要是藏在什么？第三只节里面。

说说明这个是一个键盘，对吧？键盘的一个数据，那怎么把它分离出来呢？😊，用我们的什么。用我们的一个流量啊，这里有一个有有一个。应用哈这个地方是一个说明文档哈，就是说说明你这个怎么去抓一个键盘的一个包哈啊。

怎么去抓键盘的包。因为哈因为它每一个值都是有对应的一个键盘上的一个键的，看到。😊，你比如说我刚才那第三个字节，第三个字节，如果它显示的值是04嘛。😡，就保持你按到了。😡，字母。

就是你按照你那按到的那个字母这个键A这个键。但是呢不管它是大写还是小写，因为你的无论是大写和小写，你都要按这个键嘛。😡，明白我的意思吗？😡，OK啊，我大写和小姐的键是同一个键，没错吧。😊，啊，来。

也就意味着它第三个字节呢，它对应的其实是什么？有这边映射表来对应的那你通过这个映射表呢，你可以写一个什么，你可以写一个脚本。😡，写个脚本，然后我把它运行就可以了。😊，所以说这里是怎么做的呢？首先。😡。

要把我们的一个什么呢。😡，数据哈给大家看嘛导出导出到我们的一个excel表格里面。excel表格里面这个地方CSV也是一个表格哈，表格文件啊。😊，OK保存下来之后呢，干嘛呢？😊，在得到的一个值里面。

把其实呢我们最终的目的是干嘛？是把这个数据复制下来嘛。那你要看一下。😡，你这个怎么复制啊，根本就复制不了，是不是？所以说你要把它先导出，看着啊导出。😊，导出。导出那个。结果啊为CCSV。放到这边啊。

叫做一。呃，是这个吗？啊，对。1点CSV啊，好像是这样的啊。你看一下是不是打开看一下就知道了。对吧好，有时候呢这个东西很坑的，有时候我们输入的时候啊。😊，因为我本来要输入数字嘛。

他就认为我输的是他有时候会帮我用那个科学技术法来计算出来。因为我输入的是不是其实是一个字符串嘛？😡，因为我用的是16金制来做的嘛，他有时候认为是一个。呃，如果说你是一个正常的数字，你比如说什么。

我随便在第一行吧。第一行，如果我用这么一个长的数字啊，看到啊。他有时候又用用这个科学技术法帮我表示。科学注意做法帮我表示啊，所以说啊还是蛮坑的那我现在呢只要把这一张纸是干嘛呢？😊，给它复制出来。啊。

复制出完，然后干嘛？😡，放到我的一个什么。文本里面啊放到文本里面，然后进行分析就可以了。当然也可以用什么呢？😡，也可以用我们的一个什么T shock。😊，t萨这样命令就好用住了。t萨来注意啊。

这个是固定参数啊，它是怎样的？T萨是怎么用的？😡，把我这个数据包。的。固定的数据干嘛呢？导出到1个USBda的一个文件夹里文件里面啊。OK这个就比刚才那个简单多了吗？要在卡令里面。😊，皮萨克啊。
...
哎，是我输错了是吧？稍等稍等。T下个。等一下啊等一下，这个要用。要用文本给它粘贴一下。什么意思啊？就嗯偷懒的方式，他可能有时候不不太行啊。T shock干了啊。USBE这个我看一下啊。谢不谢啊。
...
还不行是吧。😔，对呀。等一下稍等一下。看一下这个PPT啊。T shock杠RUSB点PHZ杠T filess杠EUSB点。capital data没有任问题吧，我明你应该没有问题啊。
...
但是一般情况下不会有这么这么这么这么这么那个的啊okK还有什么呢？还有HTTB的HTTBS的是没办法看得到的哈，需要导入一些证书。当然这个导入证书，我们下次课再扫一下。
