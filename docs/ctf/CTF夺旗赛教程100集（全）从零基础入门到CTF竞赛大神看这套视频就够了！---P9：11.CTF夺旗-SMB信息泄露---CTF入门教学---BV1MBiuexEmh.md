# CTF夺旗赛教程100集（全）从零基础入门到CTF竞赛大神看这套视频就够了！ - P9：11.CTF夺旗-SMB信息泄露 - CTF入门教学 - BV1MBiuexEmh
...
咱们就可以使用哎这个固定的方法来上传固定的木马来进行对应的啊提全。首先哎在上传web shell之前，咱们需要制作一个web shell。制作完web shell之后，哎，咱们需要启动监听。
